...
for k = 1 : n % On remplit la matrice pour chaque articulation
...
%%
Fc = sym('Fc', [n 1], 'real'); %frottement de coulomb
Fv = sym('Fv', [n 1], 'real');  %frottement visqueux
%% Chargement des données p.14
